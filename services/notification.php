...
class Notification extends Api
{
    ...
    public function GetAllNotification($limit_start = 0, $limit = 0)
    {
        ...
        WHERE b.account_lol_id = l.id AND b.user_id = u.id ";
        ...
        WHERE b.store_account_children_id = s.id AND b.user_id = u.id ";
        ...
        foreach ($notifications as $notification) {
            ...
            array_push($result,  $result_query);
        }
