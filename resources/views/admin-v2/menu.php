                        ...
                        <ul class="list-media">
                            <li class="list-item">
                                <a href="#" class="media-hover">
                                    <div class="media-img">
                                        <img src="<?= base_url() ?>assets/img/users/avatar-1.jpg" alt="">
                                    </div>
                                    <div class="info">
                                        <span class="title">
                                            Amanda Robertson
                            ...
                            <li class="list-item">
                                <a href="#" class="media-hover">
                                    <div class="media-img">
                                        <img src="<?= base_url() ?>assets/img/users/avatar-2.jpg" alt="">
                                    </div>
                                    <div class="info">
                                        <span class="title">
                                            Danny Donovan
                            ...
                            <li class="list-item">
                                <a href="#" class="media-hover">
                                    <div class="media-img">
                                        <img src="<?= base_url() ?>assets/img/users/avatar-3.jpg" alt="">
                                    </div>
                                    <div class="info">
                                        <span class="title">
                                            Frank Handrics
