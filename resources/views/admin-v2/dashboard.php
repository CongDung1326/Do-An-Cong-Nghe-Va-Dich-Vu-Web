            ...
            <div class="breadcrumb-wrapper row">
                ...
                <div class="col-12 col-lg-9 col-md-6">
                    <ol class="breadcrumb float-right">
                        <li><a href="<?= base_url_admin_v2() ?>">Home</a></li>
                            ...
                            <ul class="list-media">
                                <li class="list-item">
                                    <div class="client-item">
                                        <div class="media-img">
                                            <img src="<?= base_url() ?>assets/img/avatar/user1.png" alt="">
                                        </div>
                                        <div class="info">
                                ...
                                <li class="list-item">
                                    <div class="client-item">
                                        <div class="media-img">
                                            <img src="<?= base_url() ?>assets/img/avatar/user2.png" alt="">
                                        </div>
                                        <div class="info">
                                ...
                                <li class="list-item">
                                    <div class="client-item">
                                        <div class="media-img">
                                            <img src="<?= base_url() ?>assets/img/avatar/user3.png" alt="">
                                        </div>
                                        <div class="info">
                                ...
                                <li class="list-item">
                                    <div class="client-item">
                                        <div class="media-img">
                                            <img src="<?= base_url() ?>assets/img/avatar/user4.png" alt="">
                                        </div>
                                        <div class="info">
                            ...
                            <ul class="event-item">
                                <li>
                                    <a href="">
                                        <div class="media">
                                            <div class="img-thumb">
                                                <img class="img-fluid" src="<?= base_url() ?>assets/img/event/img-1.jpg" alt="">
                                            </div>
                                            <div class="text">
                                ...
                                <li>
                                    <a href="">
                                        <div class="media">
                                            <div class="img-thumb">
                                                <img class="img-fluid" src="<?= base_url() ?>assets/img/event/img-2.jpg" alt="">
                                            </div>
                                            <div class="text">
