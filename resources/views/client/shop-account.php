<?php
$call_shop_account = $call_db->get_list("SELECT * FROM store_account_parent");
?>
    ...
    <div class="shop-account-container">
        ...
        ?>
            <table class="shop-account">
                ...
                <tbody class="bottom">
                    <?php
                    $call_data_shop_account = $call_db->get_list("SELECT * FROM store_account_children WHERE store_account_parent_id={$value['id']}");
