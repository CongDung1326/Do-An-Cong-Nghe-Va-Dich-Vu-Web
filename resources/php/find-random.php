...
if (input_get(hash_encode("search"))) {
    ...
    $accounts = get_api(base_url("api/account/GetAllAccountRandom.php?search=$search"))['accounts'];
    $result = "";
    $not_found = "<tr>
    ...
    $accounts = get_api(base_url("api/account/GetAllAccountRandom.php"))['accounts'];
    $result = "";
    $not_found = "<tr>
