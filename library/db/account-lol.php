...
class AccountLolDB extends DB
{
    private $table = "account_lol";
    ...
    public function check_account_lol_exist($id_account)
    {
        return $this->exec_num_rows("account_id=$id_account") > 0 ? true : false;
    }
}
